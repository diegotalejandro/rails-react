...
class PropuestaFormUser extends Component {
  state = {
    propuesta: {
      nombre:"",
      titulo:"",
  ...
  componentDidMount() {
    ...
    this.setState({ ui });
     ...
     axios({
        method: "get",
        url: `/user/propuestas/${this.props.propuestaId}/edit.json`,
        responseType: "json",
        headers: {
      ...
      <div className="container">
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          const url = this.props.propuestaId
              ? `/user/propuestas/${this.props.propuestaId}.json`
              : `/user/propuestas.json`;
             ...
             url,{
              ...
              .then(response => {
                if (true || response.data.success) {
                  window.location.assign(`/user/propuestas?success=1`);
                  }
                 else {
                   this.showMessage({
                     show_message: true,
...
WebpackerReact.setup({PropuestaFormUser})
